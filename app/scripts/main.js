...
var cols = [
	{ resizable: true, sortable: true, field: 'isOnline'      , caption: 'Online'         , size:  '30px', render: renderBool,         style: 'text-align: center;'},
	{ resizable: true, sortable: true, field: 'isGateway'     , caption: 'Gateway'        , size:  '30px', render: renderBool,         style: 'text-align: center;'},
	{ resizable: true, sortable: true, field: 'hasVpn'        , caption: 'VPN'            , size:  '30px', render: renderBool,         style: 'text-align: center;'},
	{ resizable: true, sortable: true, field: 'hasNeighbour'  , caption: 'Link'           , size:  '30px', render: renderBool,         style: 'text-align: center;'},
	{ resizable: true, sortable: true, field: 'hasLocation'   , caption: 'Location'       , size:  '30px', render: renderBool,         style: 'text-align: center;'},
	{ resizable: true, sortable: true, field: 'vpnCnt'        , caption: 'VPNs'           , size:  '30px',                             style: 'text-align: right;'},
	{ resizable: true, sortable: true, field: 'neighbourCnt'  , caption: 'Links'          , size:  '30px',                             style: 'text-align: right;'},
	{ resizable: true, sortable: true, field: 'clients'       , caption: 'Clients'        , size:  '30px',                             style: 'text-align: right;'},
	{ resizable: true, sortable: true, field: 'id'            , caption: 'Node ID'        , size: '100px',                             style: 'font-family: monospace;'},
	{ resizable: true, sortable: true, field: 'hostname'      , caption: 'Hostname'       , size:  '50%' , min: 150},
	{ resizable: true, sortable: true, field: 'owner'         , caption: 'Owner'          , size:  '50%' , min: 150},
	...
	{ resizable: true, sortable: true, field: 'traFwd'        , caption: 'Data Fwd.'      , size:  '90px', render: renderDataAbs,      style: 'text-align: right;'},
	{ resizable: true, sortable: true, field: 'traRx'         , caption: 'Data RX'        , size:  '90px', render: renderDataAbs,      style: 'text-align: right;'},
	{ resizable: true, sortable: true, field: 'traTx'         , caption: 'Data TX'        , size:  '90px', render: renderDataAbs,      style: 'text-align: right;'},
	{ resizable: true, sortable: true, field: 'traMgmtRx'     , caption: 'Mgmt. RX'       , size:  '90px', render: renderDataAbs,      style: 'text-align: right;'},
	{ resizable: true, sortable: true, field: 'traMgmtTx'     , caption: 'Mgmt. TX'       , size:  '90px', render: renderDataAbs,      style: 'text-align: right;'},
	{ resizable: true, sortable: true, field: 'traFwdRate'    , caption: 'Data Fwd. Rate' , size:  '90px', render: renderDataRel,      style: 'text-align: right;'},
	{ resizable: true, sortable: true, field: 'traRxRate'     , caption: 'Data RX Rate'   , size:  '90px', render: renderDataRel,      style: 'text-align: right;'},
	{ resizable: true, sortable: true, field: 'traTxRate'     , caption: 'Data TX Rate'   , size:  '90px', render: renderDataRel,      style: 'text-align: right;'},
	{ resizable: true, sortable: true, field: 'traMgmtRxRate' , caption: 'Mgmt. RX Rate'  , size:  '90px', render: renderDataRel,      style: 'text-align: right;'},
	{ resizable: true, sortable: true, field: 'traMgmtTxRate' , caption: 'Mgmt. TX Rate'  , size:  '90px', render: renderDataRel,      style: 'text-align: right;'},
];
...
`,
	...
	columns: cols,
	searches: [
		{field: 'isOnline'      , caption: 'Is online'      , type: 'list', options: {items: ['1', '0']}},
		{field: 'isGateway'     , caption: 'Is gateway'     , type: 'list', options: {items: ['1', '0']}},
		{field: 'hasVpn'        , caption: 'Has VPN'        , type: 'list', options: {items: ['1', '0']}},
		{field: 'hasNeighbour'  , caption: 'Has Neighbour'  , type: 'list', options: {items: ['1', '0']}},
		{field: 'hasLocation'   , caption: 'Has location'   , type: 'list', options: {items: ['1', '0']}},
		...
		{field: 'version'       , caption: 'Gluon Version'  , type: 'combo', options: {items: Object.keys(enums.versions)}},
		{field: 'model'         , caption: 'Hardware model' , type: 'combo', options: {items: Object.keys(enums.models)}},
